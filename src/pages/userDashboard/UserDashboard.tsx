...
const UserDashboard = (): JSX.Element => {
  return (
    <div className="w-full flex flex-col justify-center items-start pb-5 h-auto gap-10">
      ...
      <div className="w-full relative flex flex-col lg:grid lg:grid-cols-3 justify-center items-center gap-5 lg:flex-row">
      ...
      <div className="w-full flex flex-col  gap-4 items-center justify-center lg:flex-row px-10">
