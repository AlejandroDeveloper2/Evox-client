...
const AutomaticSystemsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col gap-10  items-center lg:items-start justify-center px-10 w-full">
      ...
      <div className="flex flex-wrap md:grid md:grid-cols-2 gap-5 justify-center items-center md:justify-items-center w-full">
        {automatedSystems.map((item, index) => (
          <InfoCard
            style="bg-primary-color dark:bg-mediumGray w-full gap-5 "
            key={index}
          >
            <div className="flex flex-row gap-5 items-center">
              <img src={AutomatedAccountImage} alt="Evox automated accounts" />
              <p
                className="md:text-[18px] text-[16px] text-left font-montserrat 
            ...
            <Link
              to={item.to}
              className="text-white md:text-[16px] text-[14px] font-montserrat font-bold 
